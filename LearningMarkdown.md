...
## *斜体* 
在正文中想要*斜体*的效果，可以在文字的前后分别输入1个星号"*"

## **粗体** 
在正文中想要**加粗**的效果，可以在文字的前后分别输入2个星号"*"

## ***粗斜体*** 
在正文中想要***加粗+斜体***的效果，可以在文字的前后分别输入3个星号"*"
...
> 这是一句引用。This is a regular quote.

引用+强调

>     这是一句被强调的引用。This is an emphasized quote.
...
如果想输入成段代码，可以将成段的代码以三个连续的反撇号"`"包围。
...
!代表插入的是图片
[]里面是图片加载不出来的时候显示的替代文字
()里面是图片地址，如果有双引号，则双引号中是鼠标悬停于图片上时显示的文字。
...
![展示图片加载不出的替代文字](finishaaa.jpg "啊哦，图片加载不成功！")
...
| :--------------- | :----------: | ---------------: |
| <-左对齐         | ->居中对齐<-  |         右对齐->  |
| Cell_21：为了展示左对齐而加宽 | Cell_22：为了展示居中对齐而加宽 | Cell_23：为了展示右对齐而加宽 |
| Cell_31          |   Cell_32    |          Cell_33 |
